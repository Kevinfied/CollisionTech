...
line2 = sunnyFontM.render("2D recognition and how it can be used in a controlled environment (like a ", True, (77, 84, 114))
line3 = sunnyFontM.render("warehouse) to guide robots or to warn drivers about obstacles. We created a ", True, (77, 84, 114))
line4 = sunnyFontM.render("prototype model to test this idea in the real world and identify areas for ", True, (77, 84, 114))
line5 = sunnyFontM.render("improvement. Since this is simply a proof of concept, we manually adjust the ", True, (77, 84, 114))
line6 = sunnyFontM.render("OpenCV thresholds to account for specific lighting conditions. We hope that ", True, (77, 84, 114))
line7 = sunnyFontM.render("this project will serve as a stepping stone to help us improve when testing ", True, (77, 84, 114))
line8 = sunnyFontM.render("other ideas. Projects like these also help educate the public about new ", True, (77, 84, 114))
line9 = sunnyFontM.render("concepts for driving safety and robot operation. ", True, (77, 84, 114))
